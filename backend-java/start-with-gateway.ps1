...
# Start Auth Service
Write-Host "[1/6] Starting Auth Service (8083)..." -ForegroundColor Yellow
...
Write-Host "[2/6] Starting Profile Service (8082)..." -ForegroundColor Yellow
...
Write-Host "[3/6] Starting Loan Application Service (8084)..." -ForegroundColor Yellow
...
# Start Loan Service
Write-Host "[4/6] Starting Loan Service (8085)..." -ForegroundColor Yellow
...
Write-Host "[5/6] Starting Report Service (8087)..." -ForegroundColor Yellow
...
# Start API Gateway
Write-Host "[6/6] Starting API Gateway (8080)..." -ForegroundColor Yellow
